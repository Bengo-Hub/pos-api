...
func (_q *LoyaltyTransactionQuery) ForUpdate(opts ...sql.LockOption) *LoyaltyTransactionQuery {
...
func (_q *LoyaltyTransactionQuery) ForShare(opts ...sql.LockOption) *LoyaltyTransactionQuery {
	if _q.driver.Dialect() == dialect.Postgres {
		_q.Unique(false)
	}
	_q.modifiers = append(_q.modifiers, func(s *sql.Selector) {
