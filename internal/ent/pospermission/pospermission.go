...
const (
	// Label holds the string label denoting the pospermission type in the database.
	Label = "pos_permission"
	...
	// Table holds the table name of the pospermission in the database.
	Table = "pos_permissions"
	// RolesTable is the table that holds the roles relation/edge. The primary key declared below.
	RolesTable = "pos_role_permissions"
	// RolesInverseTable is the table name for the POSRoleV2 entity.
	// It exists in this package in order to avoid circular dependency with the "posrolev2" package.
	RolesInverseTable = "pos_role_v2s"
...
// Columns holds all SQL columns for pospermission fields.
var Columns = []string{
	FieldID,
	FieldPermissionCode,
	FieldName,
...
// OrderOption defines the ordering options for the POSPermission queries.
