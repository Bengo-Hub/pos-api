...
func (_q *RateLimitConfigQuery) ForUpdate(opts ...sql.LockOption) *RateLimitConfigQuery {
...
func (_q *RateLimitConfigQuery) ForShare(opts ...sql.LockOption) *RateLimitConfigQuery {
	if _q.driver.Dialect() == dialect.Postgres {
		_q.Unique(false)
	}
	_q.modifiers = append(_q.modifiers, func(s *sql.Selector) {
