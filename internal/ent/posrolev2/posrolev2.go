...
const (
	// Label holds the string label denoting the posrolev2 type in the database.
	Label = "pos_role_v2"
	...
	// Table holds the table name of the posrolev2 in the database.
	Table = "pos_role_v2s"
	// PermissionsTable is the table that holds the permissions relation/edge. The primary key declared below.
	PermissionsTable = "pos_role_permissions"
	// PermissionsInverseTable is the table name for the POSPermission entity.
	// It exists in this package in order to avoid circular dependency with the "pospermission" package.
	PermissionsInverseTable = "pos_permissions"
	// UserAssignmentsTable is the table that holds the user_assignments relation/edge.
	UserAssignmentsTable = "pos_user_role_assignments"
	// UserAssignmentsInverseTable is the table name for the POSUserRoleAssignment entity.
	// It exists in this package in order to avoid circular dependency with the "posuserroleassignment" package.
	UserAssignmentsInverseTable = "pos_user_role_assignments"
	// UserAssignmentsColumn is the table column denoting the user_assignments relation/edge.
	UserAssignmentsColumn = "pos_role_v2_user_assignments"
	// RolePermissionsTable is the table that holds the role_permissions relation/edge.
	RolePermissionsTable = "pos_role_permissions"
	// RolePermissionsInverseTable is the table name for the POSRolePermission entity.
	// It exists in this package in order to avoid circular dependency with the "posrolepermission" package.
	RolePermissionsInverseTable = "pos_role_permissions"
	// RolePermissionsColumn is the table column denoting the role_permissions relation/edge.
	RolePermissionsColumn = "role_id"
)

// Columns holds all SQL columns for posrolev2 fields.
var Columns = []string{
	FieldID,
	FieldTenantID,
	FieldRoleCode,
...
// OrderOption defines the ordering options for the POSRoleV2 queries.
