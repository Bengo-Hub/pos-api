...
// PosRolesOrErr returns the PosRoles value or an error if the edge
// was not loaded in eager-loading.
func (e UserEdges) PosRolesOrErr() ([]*UserPOSRole, error) {
	if e.loadedTypes[1] {
...
func (*User) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case user.FieldMetadata:
			values[i] = new([]byte)
		case user.FieldEmail, user.FieldSyncStatus, user.FieldFullName, user.FieldPhone, user.FieldStatus:
