...
func (_q *TenantSyncEventQuery) ForUpdate(opts ...sql.LockOption) *TenantSyncEventQuery {
...
func (_q *TenantSyncEventQuery) ForShare(opts ...sql.LockOption) *TenantSyncEventQuery {
	if _q.driver.Dialect() == dialect.Postgres {
		_q.Unique(false)
	}
	_q.modifiers = append(_q.modifiers, func(s *sql.Selector) {
