...
func (_c *UserCreate) AddPosRoleIDs(ids ...uuid.UUID) *UserCreate {
	_c.mutation.AddPosRoleIDs(ids...)
	return _c
}

// AddPosRoles adds the "pos_roles" edges to the UserPOSRole entity.
func (_c *UserCreate) AddPosRoles(v ...*UserPOSRole) *UserCreate {
...
func (_c *UserCreate) createSpec() (*User, *sqlgraph.CreateSpec) {
	...
	if nodes := _c.mutation.PosRolesIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
