...
func (_q *RoomQuery) QueryGuests() *RoomGuestQuery {
...
func (_q *RoomQuery) QueryFolioItems() *RoomFolioItemQuery {
...
func (_q *RoomQuery) FirstID(ctx context.Context) (id uuid.UUID, err error) {
	var ids []uuid.UUID
...
func (_q *RoomQuery) FirstIDX(ctx context.Context) uuid.UUID {
...
func (_q *RoomQuery) OnlyID(ctx context.Context) (id uuid.UUID, err error) {
	var ids []uuid.UUID
...
func (_q *RoomQuery) OnlyIDX(ctx context.Context) uuid.UUID {
...
func (_q *RoomQuery) IDs(ctx context.Context) (ids []uuid.UUID, err error) {
...
func (_q *RoomQuery) IDsX(ctx context.Context) []uuid.UUID {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (_q *RoomQuery) WithGuests(opts ...func(*RoomGuestQuery)) *RoomQuery {
	query := (&RoomGuestClient{config: _q.config}).Query()
...
func (_q *RoomQuery) WithFolioItems(opts ...func(*RoomFolioItemQuery)) *RoomQuery {
	query := (&RoomFolioItemClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *RoomQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Room, error) {
	...
	if query := _q.withGuests; query != nil {
		if err := _q.loadGuests(ctx, query, nodes,
			func(n *Room) { n.Edges.Guests = []*RoomGuest{} },
			func(n *Room, e *RoomGuest) { n.Edges.Guests = append(n.Edges.Guests, e) }); err != nil {
			return nil, err
		}
	}
...
func (_q *RoomQuery) loadGuests(ctx context.Context, query *RoomGuestQuery, nodes []*Room, init func(*Room), assign func(*Room, *RoomGuest)) error {
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(roomguest.FieldRoomID)
	}
	query.Where(predicate.RoomGuest(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(room.GuestsColumn), fks...))
	}))
...
func (_q *RoomQuery) loadFolioItems(ctx context.Context, query *RoomFolioItemQuery, nodes []*Room, init func(*Room), assign func(*Room, *RoomFolioItem)) error {
	fks := make([]driver.Value, 0, len(nodes))
	nodeids := make(map[uuid.UUID]*Room)
	for i := range nodes {
		fks = append(fks, nodes[i].ID)
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(roomfolioitem.FieldRoomID)
	}
...
func (_q *RoomQuery) ForUpdate(opts ...sql.LockOption) *RoomQuery {
...
func (_q *RoomQuery) ForShare(opts ...sql.LockOption) *RoomQuery {
	if _q.driver.Dialect() == dialect.Postgres {
		_q.Unique(false)
	}
	_q.modifiers = append(_q.modifiers, func(s *sql.Selector) {
